...
<body>
                    ...
                    <div class="mb-npx">
                        <div class="row align-items-center">
                            <div class="col-sm-6 col-12 mb-4 mb-sm-0">
                                <!-- Title -->
                                <h1 class="h2 mb-0 ls-tight mb-3">Add New Book</h1>
                            </div>
                            <!-- Actions -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow border-0 mb-7 p-sm-5">
                        ...
                        <div class="form-box px-sm-5 mb-5">
                            <form class="px-sm-5" action="../../backend/admin/new_book.php" method="post"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" placeholder="Book Name" required class="form-control"
                                ...
                                <select name="type" id="type">
                                    ...
                                    <option value="daily_readings">Daily Readings</option>
                                </select>
                                
                                <div class="mb-3">
                                    <br>
                                    <label for="books_num" class="form-label">Book Quantity</label>
                                    <input type="number" minlength="10" placeholder="Total Number Of Books" required
                                        class="form-control" name="books_num" aria-describedby="bookQuantity">
                                </div>
                                <div class="mb-3">
    ...
    <script>
        ...
        function cofirmdetails() {
            var are_you_sure = confirm("Are you sure to add the book to list?");

...
<body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow border-0 mb-7 p-sm-5">
                        ...
                        <div class="form-box px-sm-5 mb-5">
                            <form class="px-sm-5" action="../../backend/admin/fine.php" method="post"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" placeholder="Book ID" required class="form-control"
                                        name="student_id" aria-describedby="nameHelp">
                                </div>
                                <div class="mb-3">
                                    <label for="book_name" class="form-label">Enter Student Name(optional)</label>
    ...
    <script>
        ...
        function cofirmdetails() {
            var are_you_sure = confirm("Do you want to clear fine?")
